...
/***/ function(module, exports, __webpack_require__) {
	...
	var allChecked = function allChecked(items) {
	...
	var todoList = exports.todoList = function todoList(_ref) {
	  ...
	  return _react2.default.createElement(
	    ...
	    items.map(function (item) {
	      return _react2.default.createElement(_TodoItem2.default, _extends({ key: item.text }, item, { toggleTodo: function toggleTodo() {
	          return toggle(item.text);
	        } }));
	    }),
	...
	var mapStateToProps = function mapStateToProps(items) {
	  return { items: items };
	};
...
/***/ function(module, exports) {
	...
	var toggleTodoAction = exports.toggleTodoAction = function toggleTodoAction(text) {
	  return {
	    type: 'TOGGLE_TODO',
	    text: text
	  };
